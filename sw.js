const CACHE='ea-learnings-v1.1.0';
const CORE=['./','./index.html','./manifest.webmanifest','./assets/styles.css','./assets/app.js','./assets/icon-192.png','./assets/icon-512.png','./content/index.json','./content/search-index.json','./content/version.json'];
