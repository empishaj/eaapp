...
async function downloadOffline(){try{if(navigator.storage?.persist)await navigator.storage.persist();const cache=await caches.open('ea-mastery-v5.1.0');const core=['./','./index.html','./assets/styles.css','./assets/js/app.js','./assets/js/core/content.js','./assets/js/core/store.js','./assets/js/core/srs.js','./assets/js/core/mastery.js','./assets/js/core/utils.js','./assets/js/core/diagrams.js','./assets/js/views/dashboard.js','./assets/js/views/academy.js','./assets/js/views/lesson.js','./assets/js/views/practice.js','./assets/js/views/knowledge.js','./assets/js/views/profile.js','./content/curriculum/courses.json','./content/curriculum/lessons.json','./content/practice/cards.json','./content/practice/cases.json','./content/knowledge/lexicon.json','./content/knowledge/books.json','./content/knowledge/sources.json','./content/knowledge/search.json','./content/visuals/diagrams.json'];const urls=[...core,...content.sources.map(s=>'./'+s.path)].map(u=>new URL(u,ROOT).href);let n=0;for(const u of urls){try{await cache.add(u)}catch{}if(++n%10===0)toast(`Offline ${n}/${urls.length}`)}await preloadDiagramEngine();toast('Offline-Paket vollständig – Diagramm-Engine vorgeladen')}catch(e){toast('Offline-Paket konnte nicht vollständig geladen werden')}}
